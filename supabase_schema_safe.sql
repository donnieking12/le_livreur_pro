-- Le Livreur Pro Database Schema - Safe Execution Version
...
-- Drop existing types safely and recreate them
DO $$ BEGIN
...
-- Drop existing tables safely (in correct order due to foreign keys)
...
CREATE INDEX idx_users_is_online ON users(is_online) WHERE user_type = 'courier';
...
CREATE POLICY "Users can view own orders" ON delivery_orders FOR SELECT USING (auth.uid() = customer_id OR auth.uid() = courier_id);

-- Insert initial test data
INSERT INTO users (id, phone, full_name, user_type, is_verified)
VALUES 
    ('00000000-0000-0000-0000-000000000001', '+22505000001', 'Admin User', 'admin', true),
    ('00000000-0000-0000-0000-000000000002', '+22505000002', 'Test Customer', 'customer', true),
    ('00000000-0000-0000-0000-000000000003', '+22505000003', 'Test Courier', 'courier', true),
    ('00000000-0000-0000-0000-000000000004', '+22505000004', 'Test Partner', 'partner', true);

-- Success message
SELECT 'Le Livreur Pro database schema created successfully!' as status;